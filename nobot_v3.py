...
STAKE_TIERS = [
{“max_no”: 52, “pct”: 1.50},    # 45-52¢: 0.5% of bankroll
{“max_no”: 58, “pct”: 1.125},   # 52-58¢: 0.375% of bankroll
{“max_no”: 62, “pct”: 0.75},    # 58-62¢: 0.25% of bankroll
]
...
DAILY_LOSS_LIMIT = None  # Dynamic: 30% of current bankroll — set per scan
...
# Weather-only: only allow weather category through

WEATHER_ONLY = True

# Max stake cap — weather markets are thin, don’t blow liquidity
...
stake = min(stake, MAX_STAKE)   # cap at MAX_STAKE for liquidity
...
# Daily loss limit
daily_loss_limit = round(state["bankroll"] * 0.30, 2)
